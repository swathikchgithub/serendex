                ...
                <div className="flex flex-wrap items-center gap-3">
                  <div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] font-bold text-violet-400 bg-violet-400/10 px-2 py-1 rounded-md">
                    <span className="relative flex h-2 w-2">
                      <span className={`${data.meta.is_cached ? '' : 'animate-ping'} absolute inline-flex h-full w-full rounded-full bg-violet-400 opacity-75`}></span>
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-violet-500"></span>
                    </span>
                    {data.meta.is_cached ? 'Cached Discovery' : 'Discovery Insights'}
                  </div>
